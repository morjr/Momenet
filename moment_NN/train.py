...
parser.add_argument('--log_dir', default='log_mor6', help='Log dir [default: log]')
parser.add_argument('--num_point', type=int, default=1024, help='Point Number [256/512/1024/2048] [default: 1024]')
parser.add_argument('--max_epoch', type=int, default=550, help='Epoch to run [default: 250]')
...
copyfile(MODEL_FILE, os.path.join(LOG_DIR, FLAGS.model+'.py'))
copyfile('train.py', os.path.join(LOG_DIR, 'train.py'))
#os.system('cp %s %s' % (MODEL_FILE, LOG_DIR)) # bkp of model def
copyfile(os.path.join(BASE_DIR, 'utils', 'tf_util'+'.py'), os.path.join(LOG_DIR, 'tf_util.py'))
